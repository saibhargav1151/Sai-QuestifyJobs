...
<section class="container mx-auto p-4 mt-4">
      ...
      <div class="flex space-x-4 ml-4">
        <a href="/listings/edit/<?= $listings->id?>" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded">Edit</a>
        <!-- Delete Form -->
        <form method="POST">
        ...
        <div class="p-4">
          <h2 class="text-xl font-semibold"><?=$listings->title?></h2>
          <p class="text-gray-700 text-lg mt-2">
          <?=$listings->description?>
          </p>
          <ul class="my-4 bg-gray-100 p-4">
            <li class="mb-2"><strong>Salary:</strong> <?= salary($listings->salary) ?></li>
            <li class="mb-2">
              <strong>Location:</strong> <?=$listings->city ?>, <?= $listings->state ?>
              <span
            ...
            <li class="mb-2">
              <strong>Tags:</strong> <span><?= $listings->tags ?></span>,
              <span>Coding</span>
            </li>
          </ul>
        </div>
    ...
    <section class="container mx-auto p-4">
      ...
      <a
        href="mailto:saibhargva@gmail.com"
